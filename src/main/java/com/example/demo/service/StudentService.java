            ...
            for (Course course : enrolledCourses) {
                ...
                for (Quiz quiz : quizzes) {
                    if (quiz.getId().equals(quizId)) {
                        ...
                        // Submit the quiz and calculate the grade

                        String grade = quizService.submitQuiz(student, quizId, submission);

                        // Notify the student about their submission and grade
                        String studentMessage = "You have successfully submitted the quiz '" + quiz.getTitle()
                                + "'. Your grade is: " + grade + ".";
                        notificationService.createNotification(student.getId(), studentMessage);

                        // Notify the instructor about the student's submission
                        Instructor instructor = course.getInstructor();
                        if (instructor != null) {
                            String instructorMessage = "Student " + student.getName() + " (ID: " + student.getId()
                                    + ") has submitted the quiz '" + quiz.getTitle() + "' for your course: " + course.getTitle() + ".";
